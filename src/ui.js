...
<style>:root{color-scheme:dark}*{box-sizing:border-box}body{margin:0;background:#0b0d10;color:#e8edf2;font:14px system-ui,-apple-system,Segoe UI,sans-serif}.wrap{max-width:980px;margin:auto;padding:28px}h1{font-size:30px;margin:0 0 6px}.sub{color:#8e9aa7;margin-bottom:24px}.notice{margin:0 0 18px;padding:14px 16px;border:1px solid #745f24;border-radius:12px;background:#231f12;color:#eadb9f;line-height:1.55}.notice code{padding:2px 5px;border-radius:5px;background:#0c1014;color:#f0f4f8}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px}.card{background:#11151a;border:1px solid #252c34;border-radius:16px;padding:18px}.wide{grid-column:1/-1}label{display:block;color:#aeb8c2;margin:10px 0 6px}input,select,textarea{width:100%;padding:11px 12px;border-radius:9px;border:1px solid #303944;background:#0c1014;color:#edf3f8}textarea{min-height:96px;resize:vertical}.row{display:flex;gap:12px;flex-wrap:wrap}.check{display:flex;align-items:center;gap:8px;margin:8px 14px 8px 0}.check input{width:auto}button{border:0;border-radius:10px;padding:11px 16px;font-weight:700;cursor:pointer;background:#e9eef3;color:#11161b}.secondary{background:#252c34;color:#e8edf2}button:disabled{opacity:.45;cursor:not-allowed}.actions{display:flex;gap:10px;align-items:center;margin-top:18px;flex-wrap:wrap}.status{color:#9fb0c0}</style></head>
